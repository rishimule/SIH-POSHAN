...
class Meal(models.Model):
    ...
    caloriesp = models.FloatField("Calories (Primary)",blank=True, null=True)
    proteinsp = models.FloatField("Proteins (Primary)",blank=True, null=True)
    caloriesu = models.FloatField("Calories (Upper Primary)",blank=True, null=True)
    proteinsu = models.FloatField("Proteins (Upper Primary)",blank=True, null=True)
